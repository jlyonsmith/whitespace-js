...
test('space1 to spaces', testConvert({ in: space1, newBol: 'spaces', out: space1_spaces, info: /, mixed.*spaces/ }))
test('space2 to tabs', testConvert({ in: space2, newBol: 'tabs', round: true, out: space2_tabs, info: /, mixed.*tabs/ }))
